...
def main():
    ...
    for i in range(env.node_num):
        ...
        agents.append(PPO(int(state_dim), action_dim, lr_actor, lr_critic, gamma, K_epochs, eps_clip, True, action_std_init=0.45))
        checkpoint_path = checkpoint_p + str(i + 1) + '_5000.0.pth'
        agents[i].load(checkpoint_path)
